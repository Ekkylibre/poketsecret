...
/** Skeleton pour un visiteur AVEC session (voir profil/loading.tsx, qui choisit entre
 *  celui-ci et SignInFormSkeleton selon l'état de connexion) : reproduit la vraie page
 *  (page.tsx) pour un compte qui va effectivement voir ce contenu. */
export function ProfilContentSkeleton() {
  return (
